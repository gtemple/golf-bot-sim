...
const thruDisplay = (entry) =>
  (entry.thru_hole || 0) >= 18 ? 'F' : String(entry.thru_hole || 0)
...
const styles = {
  ...
  sectionTitle: { margin: '18px 0 10px', fontSize: 18, letterSpacing: -0.2 },
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        <div style={styles.topbar}>
          <div>
            <Link to="/" style={styles.link}>← New tournament</Link>
        ...
        <div style={styles.tableWrap}>
          <table style={styles.table}>
            ...
            <tbody>
              {leaderboardRows.map((e, idx) => (
                <tr key={e.id} style={styles.tr}>
                  <td style={styles.td}>
                    <span style={styles.dot(e.avatar_color)} />
                    <span style={{ fontWeight: 800 }}>{idx + 1}. {e.display_name}</span>
                    {e.is_human ? (
                  ...
                  <td style={{ ...styles.td, ...styles.tdMuted }}>{thruDisplay(e)}</td>
                  <td style={styles.td}>
            ...
            <div style={styles.card}>
              <div style={styles.cardHeaderRow}>
                <div>
                  ...
                  <div style={{ marginTop: 6, color: theme.text2, fontSize: 13 }}>
        ...
        <div style={styles.sectionTitle}>Human scorecards</div>
